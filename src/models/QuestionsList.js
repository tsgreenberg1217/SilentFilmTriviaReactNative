export const QUESTIONS = [
    ...
    {
      answer: 'Clara Bow',
      choices: [ 'Clara Bow', 'Janet Gaynor', 'Olive Thomas', 'Colleen Moore' ],
    ...
    },
    {
      ...
      choices: [ 'Clara Bow', 'Mary Pickford', 'Olive Thomas', 'Colleen Moore' ],
    ...
    },
    {
      ...
      choices: [ 'Flaming Youth', 'The Flapper', '7th Heaven', 'The Plastic Age' ],
    ...
    {
      answer: 'The General',
      choices: [ 'The General', 'Sherlock Jr', 'Seven Chances', 'One Week' ],
    ...
    {
      answer: 'The Big Parade',
      choices: [ 'The Big Parade', 'The General', 'Wings', 'Hearts of the World' ],
    ...
    {
      answer: 'Olive Thomas',
      choices: [ 'Olive Thomas', 'Clara Bow', 'Louise Brooks', 'Mary Astor' ],
    ...
    },
    {
      ...
      choices: [ 'Mary Pickford', 'Greta Garbo', 'Olive Thomas', 'Clara Bow' ],
    ...
    {
      answer: 'The Kid',
      choices: [ 'The Kid', 'Modern Times', 'Gold Rush', 'City Lights' ],
